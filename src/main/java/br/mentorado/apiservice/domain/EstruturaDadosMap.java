...
public interface EstruturaDadosMap {
	...
	/**
	 * Dado um mapa, retorne um map com cada chave e com a frequência com qual cada
	 * valor aparece no mapa
	 */
	public Map<String, Integer> mapaFrequenciaValores(final Map<String, String> mapa);

	/**
	 * Dado um mapa, retorne um map com cada chave e com a frequência com qual cada
	 * valor aparece nos valores da lista
	 */
	 ...
	 * 
	 * retorne um map em que a chave é a pessoa e valor uma lista de contatos com os
	 * números de telefone daquela pessoa
	 */
	...
	/**
	 * Dada um limite, adicione os números pares, impares, primos e multiplos de 10,
	 * nas suas chaves correspondentes.
	 * 
	 * EX:
	 * 
	 * ["NUMEROS_PARES", {2, 4, 6, 8, 10, n} ] ["NUMEROS_IMPARES", {1, 3, 5, 7, 9,
	 * n} ] ["NUMEROS_PRIMOS", {2, 3, 5, 7, 11, n} ] ["NUMEROS_MULTIPLOS_10", {10,
	 * 20, 30, 40, 50, n} ]
	 * 
	 */
