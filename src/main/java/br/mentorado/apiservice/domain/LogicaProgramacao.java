...
public interface LogicaProgramacao {
	...
	/**
	 * Entrada desse método irá receber uma lista de string, com informações
	 * posicionais para serem usadas para preencher o objeto pessoa.
	 * 
	 * Cada elemento da lista de Strings contém dados de uma pessoa, sendo essa
	 * String composta por:
	 * 
	 * [Nome] - 20 posições [Sobrenome] - 20 posições [Data de Nascimento] - 8
	 * posições [SEXO] - 1 posição [Profissao] - 40 posições [CPF OU CNPJ] - 14
	 * posições [Escolaridade] - 40 posições [Salario] - 10 posições [Idade] -
	 * calcular a idade [É maior de idade?] [Risco] - Seguir a regra abaixo:
	 * MENOR_IDADE: Para idade até 18 anos (Aplicar 20% na Taxa) RISCO_ALTO: Entre
	 * 18 e 23 anos. (Aplicar 15% na Taxa) RISCO_MODERADO: Entre 24 e 31 anos.
	 * (Aplicar 10% na Taxa) RISCO_BAIXO: Entre 32 e 50 anos. (Aplicar 5% na Taxa)
	 * ESPECIAL: Acima de 50 anos. (Aplicar 1% na Taxa) [Taxa] - Aplicar o valor da
	 * taxa sobre o salario.
	 * 
	...
	/**
	 * Entrada desse método será uma lista de pessoas, que deve convertida para o
	 * formato String.
	 * 
	 ...
	 * [Nome] - 20 posições [Sobrenome] - 20 posições [Data de Nascimento] - 8
	 * posições [SEXO] - 1 posição [Profissao] - 40 posições [CPF OU CNPJ] - 14
	 * posições [Escolaridade] - 40 posições [Salario] - 10 posições
	 * 
	 * @param lista - String posicional
	...
	/**
	 * Entrada desse método irá receber um array de strings, com informações
	 * posicionais para serem usadas para preencher o objeto pessoa.
	 * 
	 * O array é composto de:
	 * 
	 * [Nome] - posição 0 [Sobrenome] - posição 1 [Data de Nascimento] - posição 2
	 * [SEXO] -posição 3 [Profissao] - posição 4 [CPF OU CNPJ] - posição 5
	 * [Escolaridade] - Coluna 6 [Salario] - Coluna 7 [Idade] - calcular a idade [É
	 * maior de idade?] [Risco] - Seguir a regra abaixo: MENOR_IDADE: Para idade até
	 * 18 anos (Aplicar 20% na Taxa) RISCO_ALTO: Entre 18 e 23 anos. (Aplicar 15% na
	 * Taxa) RISCO_MODERADO: Entre 24 e 31 anos. (Aplicar 10% na Taxa) RISCO_BAIXO:
	 * Entre 32 e 50 anos. (Aplicar 5% na Taxa) ESPECIAL: Acima de 50 anos. (Aplicar
	 * 1% na Taxa) [Taxa] - Aplicar o valor da taxa sobre o salario.
	 * 
	 * @param array
	...
	/**
	 * Entrada desse método irá receber um Array Multidimensional, com informações
	 * para serem usadas para preencher o objeto pessoa.
	 * 
	 * O array é composto de:
	 * 
	 * [Nome] - Coluna 0 [Sobrenome] - Coluna 1 [Data de Nascimento] - Coluna 2
	 * [SEXO] - Coluna 3 [Profissao] - Coluna 4 [CPF OU CNPJ] - Coluna 5
	 * [Escolaridade] - Coluna 6 [Salario] - Coluna 7 [Idade] - calcular a idade [É
	 * maior de idade?] [Risco] - Seguir a regra abaixo: MENOR_IDADE: Para idade até
	 * 18 anos (Aplicar 20% na Taxa) RISCO_ALTO: Entre 18 e 24 anos. (Aplicar 15% na
	 * Taxa) RISCO_MODERADO: Entre 24 e 32 anos. (Aplicar 10% na Taxa) RISCO_BAIXO:
	 * Entre 32 e 50 anos. (Aplicar 5% na Taxa) ESPECIAL: Acima de 50 anos. (Aplicar
	 * 1% na Taxa) [Taxa] - Aplicar o valor da taxa sobre o salario.
	 * 
	 ...
	 * 
	 * Coluna 0 - Valores pares Coluna 1 - Valores Impares Coluna 2 - Valores primos
	...
	/**
	 * Entrada desse método irá receber um Array Multidimensional e posição da
	 * informação desejada.
	 * 
	 * Retornar um array composto de:
	 * 
	 * Coluna 0 - antecessor da posição Coluna 1 - sucessor da posição Coluna 2 -
	 * acima da posição Coluna 3 - abaixo da posição
	 * 
	 * @param arrayMultidimensional
	 * 
	 * 
	 ...
	 */
	public String[] arrayMultidimensionalPorPosicoes(final String[][] arrayMultidimensional, final int coluna,
			final int linha);

	/**
	 * Entrada desse método irá receber um Array Multidimensional e o valor da
	 * informação desejada.
	 * 
	 * Retornar um array composto de:
	 * 
	 * Coluna 0 - antecessor ao valor Coluna 1 - sucessor ao valor Coluna 2 - acima
	 * ao valor Coluna 3 - abaixo ao valor
	 * 
	 * @param arrayMultidimensional
	 * 
	 * @return array de Strings
	 ...
	 * 
	 * [0] - antecessor da posição [1] - sucessor da posição
	 * 
	 * @param array
	 * @return array
	 */
	 ...
	 * 
	 * [0] - antecessor ao valor [1] - sucessor ao valor
	 * 
	 * @param array
	 * @return array
	 */
	 ...
	 * 
	 * [0] - Primeiro elemento do array [1] - ultimo elemento do array
	 * 
	 * @param limite - Limite
	 * 
	 * @return resultado
	 ...
	 * Retorna um array de 2 posições, até o valor limite, começando de zero.
	 * 
	 * [0] - Primeiro elemento do array - Quantidade de valores Pares [1] - Segunda
	 * elemento do array - Quantidade de valores Impares [2] - Terceiro elemento do
	 * array - Quantidade de valores Primos
	 * 
	 * @param inicio - inicio
	 * @param fim    - fim
	 * 
	 ...
	 * 
	 * [0] - Primeiro elemento do array [1] - ultimo elemento do array [2] - média
	 * de todos os valores
	 * 
	 * @param limite - Limite
	 * 
	 ...
	 * @return A palavra <b>PAR</b> se for par e <b>IMPAR</b> (SEM ACENTO) caso seja
	 *         ímpar
	 ...
	 * WHILE
	 * 
	 * Dado um número inteiro, retornar o dobro de cada valor incrementado em 1 até
	 * que se chege ao dobro do valor informado: Ex: valor=5 Retorna [10, 12, 14,
	 * 16, 18, 20] desmembrando 5*2=10 6*2=12 7*2=14 ... 10*2=20 (10 é o dobro do
	 * valor informado)
	 * 
	 ...
	 * WHILE
	 * 
	 * Dado um número inteiro, retorno o dobro do número e incremente o número até
	 * que o número informado chegue a 10 Ex: valor=8 Retorna [16, 17, 20]
	 * 
	 * Ex: valor=15 Retorna []
	 * 
	 * @param valor - Valor a dobrar e iterar
	 ...
	 * DO-WHILE
	 * 
	 * Dado um número inteiro, dobre-o até que o número seja maior ou igual a 1000,
	 * retorne os resultados EX: número=10 - imprime 20 - imprime 40 - imprime 80 -
	 * imprime 160 - imprime 320 - imprime 640 - imprime 1280
	 * 
	 * Ex2: número 1500 - imprime 3000
	 * 
	 ...
	 * 
	 * EX: número=2 1, 1, 1 1, 2, 2 1, 3, 3 ... 1, 10, 10 2, 1, 2 2, 2, 4 2, 3, 6
	 * ... 2, 10, 20
	 *
	 * 
